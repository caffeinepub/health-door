...
export class Backend implements backendInterface {
    ...
    async analyzeImage(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getScans(): Promise<Array<ScanRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getScans();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveScan(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveScan(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
